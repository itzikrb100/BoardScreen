...
public class RowTitleResult extends TableRow {
    ...
    public RowTitleResult(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RowTitleResult(Context context) {
        super(context);
    }
